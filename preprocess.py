...
# train = load_pickle_file("./data_preprocessed/training_data.pkl")
# train_labels = load_pickle_file("./data_preprocessed/training_data.pkl")
...
original_features = list(app_train_poly.columns)
print('Original Number of Features: ', len(original_features))


# Merge with the value counts of bureau
app_train_poly = app_train_poly.merge(bureau_counts, on = 'SK_ID_CURR', how = 'left')

# Merge with the stats of bureau
app_train_poly = app_train_poly.merge(bureau_agg, on = 'SK_ID_CURR', how = 'left')

# Merge with the monthly information grouped by client
app_train_poly = app_train_poly.merge(bureau_balance_by_client, on = 'SK_ID_CURR', how = 'left')

new_features = list(app_train_poly.columns)
...
# app_train_poly_labels = app_train_poly['TARGET']

# Align the dataframes, this will remove the 'TARGET' column
# app_train_poly, test = app_train_poly.align(test, join = 'inner', axis = 1)
...
app_train_poly = convert_types(app_train_poly, print_info=True)
